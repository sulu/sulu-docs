...
whereby all the available :doc:`index` (including the block itself, since we do     support nesting since 2.1) can be used. These types are offered to the content
