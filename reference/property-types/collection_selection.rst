...
.. note::
    ...
    This property type passes an array of Collection_ entities to the twig template. It does not provide the media
...
.. list-table::
    ...
    * - min
      - string
      - The minimum number of selected collections
    * - max
      - string
      - The maximum number of selected collections
