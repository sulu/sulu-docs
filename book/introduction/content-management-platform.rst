...
When it comes to Content Management a lot of terms are used. CMS, CMF, 
...
web applications or large scale web platforms. A "Content Management System" (CMS) is a
...
Sulu is capable of managing the content of websites and fully supports the
...
meaning other formats (such as XML) can be easily applied. Other
...
modern browsers without the need for any plugins and will work on a standard
